...
<html>
  <head>
    <title>用户列表</title>
	<meta http-equiv="pragma" user="no-cache">
	<meta http-equiv="cache-control" user="no-cache">
	<meta http-equiv="expires" user="0">    
	<meta http-equiv="keywords" user="keyword1,keyword2,keyword3">
	<meta http-equiv="description" user="This is my page">
	<%@include file="/WEB-INF/pages/admins/common/common.jsp"%>
	<!--dynamic table-->
    <link href="${basePath}/resources/admins/js/advanced-datatable/css/demo_page.css" rel="stylesheet" />
    <link href="${basePath}/resources/admins/js/advanced-datatable/css/demo_table.css" rel="stylesheet" />
    <link href="${basePath}/resources/admins/js/data-tables/DT_bootstrap.css" rel="stylesheet" />
 </head>
 ...
 <section>
	...
	<!--dynamic table-->
	<script type="text/javascript" language="javascript" src="${basePath}/resources/admins/js/advanced-datatable/js/jquery.dataTables.js"></script>
	<script type="text/javascript" src="${basePath}/resources/admins/js/data-tables/DT_bootstrap.js"></script>
	
	<!--dynamic table initialization -->
	<script src="${basePath}/resources/admins/js/dynamic_table_init.js"></script>
	...
	<script type="text/javascript">
		$(function(){
			$.ajax({
				type:"post",
				url: basePath + "/admin/user/template",
