	...
	<div class="divBody">
		...
		<div class="divContent">
			<div style="margin: 20px;">
				<img src="${basePath}/resources/imgs/msg/duihao.jpg" width="150" style="float:left; margin-right:30px;"/> 
				<span style="font-size:30px;color:#c30;font-weight:900;">恭喜您激活成功，马上登录！</span>
				<br/> <br/> <br/> <br/> 
